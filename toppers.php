...
<head>
    ...
    <meta name="title" content="IAS PREPARATION TIPS FROM PRAGMA TOPPERS | <?php echo $ProjectName; ?>">
    ...
    <meta property="og:title" content="IAS PREPARATION TIPS FROM PRAGMA TOPPERS | <?php echo $ProjectName; ?>">
    ...
    <meta property="twitter:title" content="IAS PREPARATION TIPS FROM PRAGMA TOPPERS | <?php echo $ProjectName; ?>">
