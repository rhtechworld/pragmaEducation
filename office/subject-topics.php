...
<html lang="en">
    <head>
        ...
        <title>Subject Topics | <?php echo $ProjectName; ?></title>
        <?php include('header.php'); ?>
                <main>
                    <div class="container-fluid px-4">
                        <h5 class="mt-4">Subject Topics</h5>
                        <?php include('functions/all-subject-topics-actions.php'); ?>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="./">Dashboard</a></li>
                            <li class="breadcrumb-item active">Subject Topics </li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="" method="POST">
                                    ...
                                    <div class="form-group">
                                         ...
                                         <div id="getSubjectsByTypes"></div>
                                        
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6">
                                        <button type="submit" name="viewCourseSubjects" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> View Subject Topics</button>
                                        </div>
                                        <div class="col-md-6 col-lg-6">
                                        <button type="submit" name="AddNewCourseSubjects" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Add New Subject Topic</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
