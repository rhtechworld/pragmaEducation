                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active"><a href="all-course-videos">Course Videos</a> &nbsp;/ &nbsp;<b><?php echo $course_name; ?></b> &nbsp;/ &nbsp;Add New Video </li>
                        </ol>
                                    ...
                                    <?php
                                        ...
                                        else
                                        {
                                            while($row = mysqli_fetch_array($getvideosQuery))
                                            {
                                                ...
                                                if($status == 0)
                                                {
                                                    $showStatus = '<span class="badge badge-success">Public</span>';
                                                }
                                                else
                                                {
                                                    $showStatus = '<span class="badge badge-danger">Private</span>';
                                                }
