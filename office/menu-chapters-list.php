...
<html lang="en">
    <head>
        ...
        <title>Subject Chapters | <?php echo $ProjectName; ?></title>
        <?php include('header.php'); ?>
                <main>
                    <div class="container-fluid px-4">
                        <h5 class="mt-4">Subject Chapters</h5>
                        <?php include('functions/menu-chapters-list-actions.php'); ?>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="./">Dashboard</a></li>
                            <li class="breadcrumb-item active">Subject Chapters </li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <button type="submit" name="viewCourseSubjectChapters" class="btn btn-primary btn-block"> Add / View Subject Chapters</button>
                                        </div>
                                    </div>   
