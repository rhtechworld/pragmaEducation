...
<html lang="en">
    <head>
        ...
        <title>Course Videos | <?php echo $ProjectName; ?></title>
        <?php include('header.php'); ?>
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Course Videos</h3>
                            ...
                            <div class="card-body">
                                <form action="" method="POST">
                                    ...
                                    <div class="row">
                                        ...
                                        <button type="submit" name="viewCourseVideos" class="btn btn-primary btn-block"><i class="fa fa-eye"></i> View Course Videos</button>
                                        </div>
                                        <div class="col-md-6 col-lg-6">
                                        <button type="submit" name="AddNewCourseVideo" class="btn btn-primary btn-block"><i class="fa fa-plus"></i> Add New Course Video</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
