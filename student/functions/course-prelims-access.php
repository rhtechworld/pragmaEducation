<?php
                ...
                {
                    while($row = mysqli_fetch_array($getSubjectsOnPrilims))
                    {
                        ...
                        $getSubjectsAsPerPapers = mysqli_query($conn,"SELECT * FROM subjects WHERE subject_type='Prelims' AND course_id='$course_id_CourseDashboard' AND subject_paper='$subject_paper' AND isDeleted='0'");
