...
<head>
  ...
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
    ...
    <meta name="title" content="All Updates and Announcements | <?php echo $ProjectName; ?>">
    ...
    <meta property="og:title" content="All Updates and Announcements | <?php echo $ProjectName; ?>">
    ...
    <meta property="twitter:title" content="All Updates and Announcements | <?php echo $ProjectName; ?>">
