        ...
        <div class="container">
            <div class="text-center mb-5">
                    ...
                    <div class="col-md-12 col-lg-12 p-4 border rounded">
                        <div class="row">
                            <div class="col-md-4 col-lg-4">
                                <img src="photos/bharath.jpeg" class="rounded" height="100">
                            </div>
                            <div class="col-md-8 col-lg-8">
                                <h4>Bharat Bhushan Rallapalli</h4>
                ...
                <div class="row my-auto">
                    <div class="col-md-12 col-lg-12 p-4 border rounded">
                        <div class="row">
                            <div class="col-md-4 col-lg-4 p-3 text-center">
                                <img src="photos/nb.png" class="rounded" height="100">
                                <h5 class="mt-2"><b>Narasimha Bhoopati</b></h5>
                                <p><b>Faculty</b> | <a href="#" style="color:#E61F26">View Details</a></p>
                            </div>
                            <div class="col-md-4 col-lg-4 p-3 text-center">
                                <img src="photos/vk.png" class="rounded" height="100">
                                <h5 class="mt-2"><b>Dr. Vijay Kumar C</b></h5>
                                <p><b>Faculty</b> | <a href="#" style="color:#E61F26">View Details</a></p>
                            </div>
                            <div class="col-md-4 col-lg-4 p-3 text-center">
                                <img src="photos/dm.jpeg" class="rounded" height="100">
