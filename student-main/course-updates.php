...
<head>
    ...
    <main id="main">
        ...
        <div class="row my-auto text-center">
                <div class="col-lg-6 col-md-6 my-auto">
                    <b class="text-center"><?php echo $assigned_assign_id; ?></b> | <b><a href="course-updates?course_id=<?php echo $assigned_course_id; ?>&assign_id=<?php echo $assigned_assign_id; ?>" style="color:#E31E26">Course Updates</a></b>
                </div>
    ...
    $("#updates"+actionCourseId).addClass("active");
