<?php
                ...
                $getSubjectsOnPayments = mysqli_query($conn,"SELECT * FROM student_txns WHERE  assign_id='$ts_assigned_id' AND student_id='$student_id_session' AND isDeleted='0' ORDER BY id DESC");
