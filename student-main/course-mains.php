...
<head>
    ...
    <main id="main">
        ...
        <div class="section-head col-sm-12 mb-0" style="margin-top:105px;">
            <h4 style="font-size:20px"><span>Mains :  </span> <?php echo $course_name_CourseDashboard; ?> </h4>
        </div>
        ...
        <div class="row my-auto text-center">
                <div class="col-lg-6 col-md-6 my-auto">
                    <b class="text-center"><?php echo $assigned_assign_id; ?></b> | <b><a href="course-mains?course_id=<?php echo $assigned_course_id; ?>&assign_id=<?php echo $assigned_assign_id; ?>" style="color:#E31E26">Course Mains</a></b>
                </div>
