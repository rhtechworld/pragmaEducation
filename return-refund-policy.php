...
<head>
  ...
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
    ...
    <!-- Primary Meta Tags -->
    <title>Return & Refund Policy | <?php echo $ProjectName; ?></title>
    <meta name="title" content="Return & Refund Policy | <?php echo $ProjectName; ?>">
    ...
    <meta property="og:title" content="Return & Refund Policy | <?php echo $ProjectName; ?>">
    ...
    <meta property="twitter:title" content="Return & Refund Policy | <?php echo $ProjectName; ?>">
  ...
  <main id="main">
    ...
    <div class="text-center mb-0" style="margin-top:105px;">
        <div class="section-head col-sm-12 mb-0">
          <h4 style="font-size:20px"><span>Return &<br> Refund Policy</span></h4>
        </div>
    </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <p>Thank you for shopping at Pragma Education.</p>
        ...
        <ul>
        <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Pragma Education.</p>
        </li>
        <li>
        ...
        <li>
        <p><strong>Website</strong> refers to Pragma Education, accessible from <a href="https://pragmaeducation.com/" rel="external nofollow noopener" target="_blank">https://pragmaeducation.com/</a></p>
        </li>
        <li>
        ...
        <ul>
        <li>By visiting this page on our website: <a href="https://pragmaeducation.com/contact" rel="external nofollow noopener" target="_blank">https://pragmaeducation.com/contact</a></li>
        </ul>
