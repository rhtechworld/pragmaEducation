...
<?php include('functions/main-functions/getCurrentAffairView.php'); ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
  ...
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
    ...
    <!-- Primary Meta Tags -->
    <title><?php echo $ca_title; ?> | <?php echo $ProjectName; ?></title>
    <meta name="title" content="<?php echo $ca_title; ?> | <?php echo $ProjectName; ?>">
    ...
    <meta property="og:title" content="<?php echo $ca_title; ?> | <?php echo $ProjectName; ?>">
    ...
    <meta property="twitter:title" content="<?php echo $ca_title; ?> | <?php echo $ProjectName; ?>">
