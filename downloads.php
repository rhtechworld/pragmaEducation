...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title>Free IAS Preparation Materials | <?php echo $ProjectName; ?></title>
    <meta name="title" content="Free IAS Preparation Materials | <?php echo $ProjectName; ?>">
    ...
    <meta property="og:title" content="Free IAS Preparation Materials | <?php echo $ProjectName; ?>">
    ...
    <meta property="twitter:title" content="Free IAS Preparation Materials | <?php echo $ProjectName; ?>">
