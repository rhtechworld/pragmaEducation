...
<head>
  ...
  <meta content="width=device-width, initial-scale=1.0" name="viewport">
    ...
    <meta name="title" content="<?php echo $ann_title; ?> | <?php echo $ProjectName; ?>">
    ...
    <meta property="og:title" content="<?php echo $ann_title; ?> | <?php echo $ProjectName; ?>">
    ...
    <meta property="twitter:title" content="<?php echo $ann_title; ?> | <?php echo $ProjectName; ?>">
