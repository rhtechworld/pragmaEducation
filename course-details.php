...
<head>
    ...
    <meta name="title" content="<?php echo $course_name; ?> | <?php echo $ProjectName; ?>">
    ...
    <meta property="og:title" content="<?php echo $course_name; ?> | <?php echo $ProjectName; ?>">
    ...
    <meta property="twitter:title" content="<?php echo $course_name; ?> | <?php echo $ProjectName; ?>">
